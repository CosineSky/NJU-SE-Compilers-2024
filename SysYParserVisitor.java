...
public interface SysYParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link SysYParser#assignment}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAssignment(SysYParser.AssignmentContext ctx);
	/**
	 * Visit a parse tree produced by {@link SysYParser#possibleExp}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	 ...
	 * @return the visitor result
	 */
	T visitParenCond(SysYParser.ParenCondContext ctx);
	/**

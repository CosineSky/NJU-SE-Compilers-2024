...
assignment: lVal ASSIGN exp SEMICOLON;
possibleExp: (exp)? SEMICOLON;
blockStmt: block;
ifStmt: IF L_PAREN cond R_PAREN stmt (ELSE stmt)?;
whileStmt: WHILE L_PAREN cond R_PAREN stmt;
...
exp: L_PAREN exp R_PAREN # parenExp
	| lVal # lValExp
	| number # numExp
	| funcName L_PAREN funcRParams? R_PAREN # funcCallExp
...
// 条件表达式
cond: exp # condExp
    | L_PAREN cond R_PAREN #parenCond
